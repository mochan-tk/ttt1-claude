...
Follow `.claude/skills/context-distillation/SKILL.md`.

Topic directory to distill: docs/context/$1
...
4. Assign each piece of knowledge a tier (always-on / scoped / on-demand) per
   the skill's tiering table, and include any rules/skill file edits the
   tiering implies.
